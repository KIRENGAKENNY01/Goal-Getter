...
const LogPopup:React.FC = ()=>{
    return (
<Popup trigger={<button className='flex gap-5 mt-20 ml-5 '>
            <img src={logout} alt="handle with care" className='w-[20%]'/>
             <p className='text-white font-semibold text-[1.3rem] self-center'>Log out</p>
